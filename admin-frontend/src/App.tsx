            ...
            <Routes>
              ...
              <Route element={<AuthGuard />}>
                ...
                <Route element={
                  ...
                  <Route path="/access" element={<AdminGuard><AccessControl /></AdminGuard>} />
                  {/* 旧路径兼容重定向 */}
                  <Route path="/users" element={<Navigate to="/access" replace />} />
                  <Route path="/course" element={<Course />} />
                  <Route path="/tasks" element={<AdminGuard><Tasks /></AdminGuard>} />
                  <Route path="/push" element={<AdminGuard><Push /></AdminGuard>} />
