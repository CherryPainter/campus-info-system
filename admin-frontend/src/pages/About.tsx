...
import { Typography, Divider, Card, Row, Col, Tag, List, Descriptions } from "antd";
import {
  CloudOutlined,
  ThunderboltOutlined,
  BookOutlined,
    ...
    <div style={{ maxWidth: 1000, margin: "40px auto", padding: "0 24px" }}>
      ...
      >
        ...
        <Paragraph style={{ fontSize: 15, lineHeight: 2, textIndent: "2em" }}>
          ...
          （推送任务持久化、失败重试）， 致力于成为校园日常信息传递的可靠桥梁。
        </Paragraph>
      </Card>
        ...
        {features.map((item) => (
          <Col xs={24} sm={12} lg={8} key={item.title}>
            ...
            >
              ...
              <Paragraph
                type="secondary"
                style={{ fontSize: 13, lineHeight: 1.8, textAlign: "center" }}
              >
                {item.desc}
              </Paragraph>
      ...
      {/* 系统结构 */}
      <Title level={3} style={{ textAlign: "center", margin: "32px 0 24px" }}>
        系统结构
      </Title>
      <Row gutter={[16, 16]}>
      ...
      <Card
        bordered={false}
        style={{ borderRadius: 12, boxShadow: "0 2px 12px rgba(0,0,0,0.06)", marginTop: 24 }}
      >
        ...
        <Row gutter={[24, 24]}>
          <Col xs={24} sm={12}>
            <div style={{ display: "flex", gap: 12 }}>
              <BookOutlined
                style={{ fontSize: 26, color: "#1890ff", flexShrink: 0, marginTop: 2 }}
              />
              <div>
                ...
                <Paragraph
                  type="secondary"
                  style={{ margin: "4px 0 0", fontSize: 13, lineHeight: 1.7 }}
                >
          ...
          <Col xs={24} sm={12}>
            <div style={{ display: "flex", gap: 12 }}>
              <ThunderboltOutlined
                style={{ fontSize: 26, color: "#faad14", flexShrink: 0, marginTop: 2 }}
              />
              <div>
                <Title level={5} style={{ margin: 0, fontSize: 15 }}>
                  填补信息盲区
          ...
          <Col xs={24} sm={12}>
            <div style={{ display: "flex", gap: 12 }}>
              <AppstoreOutlined
                style={{ fontSize: 26, color: "#722ed1", flexShrink: 0, marginTop: 2 }}
              />
              <div>
                <Title level={5} style={{ margin: 0, fontSize: 15 }}>
                  从一到多
          ...
          <Col xs={24} sm={12}>
            <div style={{ display: "flex", gap: 12 }}>
              <SafetyOutlined
                style={{ fontSize: 26, color: "#52c41a", flexShrink: 0, marginTop: 2 }}
              />
              <div>
                <Title level={5} style={{ margin: 0, fontSize: 15 }}>
                  可靠且安全
